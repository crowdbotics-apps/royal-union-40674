"""
Django settings for royal_union_40674 project.
...
ROOT_URLCONF = 'royal_union_40674.urls'
...
WSGI_APPLICATION = 'royal_union_40674.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "royal_union_40674 API",
    "DESCRIPTION": "API documentation for royal_union_40674 App",
    "VERSION": "v1",
}
